        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex-1">
            <p className="text-gray-700">
              Organizing a wedding is something magical, really special. We want
              to help you make the most of this unique and unrepeatable moment
              with the best ideas and the most useful advice. Discover in our
              articles all the inspiration you are looking for for your big day.
            </p>
          </div>
