      ...
      <div className="container px-4 mx-auto">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            ...
            <ul className="list-unstyled flex">
              <li>
                <a href="https://www.facebook.com/weddsellonline">
                  <FaFacebookF className="text-2xl mr-4" />
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/weddsell/">
          ...
          <div className="w-full md:w-1/4">
            ...
            <form>
              <div className="flex mb-4">
                <input
                  type="email"
                  className="w-full bg-gray-800 rounded py-2 px-4 text-white"
                  placeholder="Your e-mail"
                />
                <button
                  type="submit"
                  className="bg-gray-700 rounded py-2 px-4 ml-4 text-white"
                >
                  Subscribe
                </button>
              </div>
        ...
        <div className="flex justify-center mt-10">
          <p className="text-sm text-gray-400">
            &copy; 2023 WeddSell. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
